...
const Project = props => {
  const { name, image, url, description, date, status, tags, icon } = props
  return (
    <div className="border-t-4 border-line relative flex flex-wrap bg-back-light p-4 lg:p-8 bg-no-repeat text-sm mb-4">
      {image && (
